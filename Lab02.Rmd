...
a.	Is the probability of having Dupuytren related to Age? Fit a Binomial model with logistic link function without and with correcting for over-dispersion using Pearson’s Chi-square value and compare your results with the results shown in the recorded lecture. Compare the model with and without correcting for over-dispersion.
