...
mdl.w <- lm(pemax~height, data=d )
predict(mdl, data.frame(height=150), interval="confidence")
mdl.h <- lm(pemax~weight, data=d )
...
a. What is the distribution of the log-likelihood? What are the values of the parameters $\mu, \sigma$ that maximize the log-likelihood?

b. Create a heat-map or a contour map as follows, and identify which parameter values maximize the log likelihood. 

c. Are these the parameters you expected? Why or why not? 
